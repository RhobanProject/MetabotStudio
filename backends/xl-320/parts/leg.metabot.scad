...
{
// metabot: Begining module leg
marker("metabot_part: leg");
marker("metabot_parameter: fixationAngle ", fixationAngle);
marker("metabot_parameter: mode ", mode);
marker("metabot_parameter: print ", print);
marker("metabot_parameter: sizeA ", sizeA);
marker("metabot_parameter: sizeB ", sizeB);
marker("metabot_parameter: sizeBottom ", sizeBottom);
marker("metabot_parameter: sizeC ", sizeC);
marker("metabot_parameter: sizeTop ", sizeTop);
marker("metabot_parameter: thickness ", thickness);
if (NoModels == false) {
_leg(fixationAngle=fixationAngle,mode=mode,print=print,sizeA=sizeA,sizeB=sizeB,sizeBottom=sizeBottom,sizeC=sizeC,sizeTop=sizeTop,thickness=thickness);
}
}
module _leg(fixationAngle=0, mode="arm", print=false, sizeA=60, sizeB=20, sizeBottom=10, sizeC=20, sizeTop=15, thickness=2.2) {
