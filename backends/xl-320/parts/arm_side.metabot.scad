...
{
// metabot: Begining module arm_side
marker("metabot_part: arm_side");
marker("metabot_parameter: distance ", distance);
marker("metabot_parameter: firstPart ", firstPart);
marker("metabot_parameter: print ", print);
marker("metabot_parameter: radius ", radius);
marker("metabot_parameter: thickness ", thickness);
if (NoModels == false) {
_arm_side(distance=distance,firstPart=firstPart,print=print,radius=radius,thickness=thickness);
}
}
module _arm_side(distance=40, firstPart=12, print=false, radius=10, thickness=2.2) {
...
// metabot: Ending module arm_side
